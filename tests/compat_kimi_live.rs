...
//!
//! NOTE: this live test still documents the pre-service harness shape and
//! needs to be migrated to initialize upstreams/models/keys through the admin
//! API before it is useful against the managed service entrypoint.
