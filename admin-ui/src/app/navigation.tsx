import { Activity, Gauge, KeyRound, Route, Server, SlidersHorizontal } from "lucide-react";

export type Tab = "overview" | "upstreams" | "models" | "keys" | "logs" | "settings";
...
export function tabTitle(tab: Tab) {
  return { overview: "运行总览", upstreams: "渠道管理", models: "模型映射", keys: "分发密钥", logs: "请求日志", settings: "运行设置" }[tab];
}
